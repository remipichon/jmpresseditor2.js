...
//   $objet.data('off').x =  VLeftMouse - offLeft;
//   $objet.data('off').x =  VTopMouse - offTop;
...
//                    console.log($container);
      ...
      if ($container === 0) {         // = drop de l'element sur slideArea
        $this.css("left", $this.data('off').x);
        $this.css("top", $this.data('off').y);
      }
